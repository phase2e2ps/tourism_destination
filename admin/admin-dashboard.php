...
<body>
    <h1><b style="margin-left: 50%; font-size: 50px;">Dashboard</b></h1>
    <!-- Sidebar Navigation -->
    <tbody>
        <aside class="sidebar">
                    ...
                    <table style="margin-left: 14%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row['name_tb']; ?></td>
                                <td><?= $row['email_tb']; ?></td>
                                <td><?= $row['contact_tb']; ?></td>
                                <td><?= $row['message_tb']; ?></td>
                                <td><a href="../edit-update/admin-dashboard.php?id=<?= $row['id']; ?>"><i class="fa fa-edit"></i></a></td>
                            </tr>
                    <?php
                                    }
                                } else {
